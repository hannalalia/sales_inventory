...
<div class="container">
     ...
     <table class="mx-auto table table-sm table-hover table-responsive text-center" id="po_table">
    	...
    	<tbody>
    		...
    		<tr>
    			...
    			<td><a class="btn btn-sm btn-info"  href="<?php echo url_for('admin/purchase_orders/create_invoice.php?id='. $po['purchase_order_id'])?>">
                    Invoice
                </a></td>
    ...
    <a class="btn btn-info text-light m-2" href="<?php echo url_for('admin/purchase_orders/index.php')?>" >Back</a>
