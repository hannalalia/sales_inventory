...
<?php require('../../../private/shared/public_navigation.php');?>
    ...
    <table class="mx-auto table table-sm table-hover table-responsive-lg text-center" id="po_table">
    	...
    	<tbody>
    		...
    		<tr>
    			...
    			<td><a class="btn btn-sm bg-transparent text-secondary"  href="<?php echo url_for('admin/purchase_orders/view.php?id='. $po['purchase_order_id'])?>">
    ...
    <a class="btn btn-info text-light m-2" href="<?php echo url_for('admin/purchase_orders/new.php')?>" >Create Purchase Order</a>
    <a class="btn btn-info text-light m-2" href="<?php echo url_for('admin/purchase_orders/po_recon.php')?>" >P.O. Recon</a>
    </div>
<?php require('../../../private/shared/public_footer.php');?>
<script type="text/javascript" src="<?php echo url_for('admin/resources/js/populate_category.js')?>"></script>
<script >
