...
<style type="text/css">
  ...
  <body>
    <ul class="nav nav-tabs mt-3">
      <li class="nav-item">
        <a class="nav-link text-dark" href="<?php echo url_for('admin/stock_adjustments/index.php')?>">Stock Adjustment</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active text-dark" href="#">Stock Adjustment History</a>
      </li>
<!--       <li class="nav-item">
        <a class="nav-link text-dark" href="<?php echo url_for('admin/stock_adjustments/approve_adj.php')?>">Approve Adjustments</a>
      </li> -->
    </ul>
...
<script type="text/javascript" src="<?php echo url_for('admin/resources/js/populate_stock_adj.js')?>"></script>
<script type="text/javascript" src="<?php echo url_for('admin/resources/js/print.js')?>">
</script>
<script >
