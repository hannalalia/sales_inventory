...
<style type="text/css">
  ...
  <body>
    <ul class="nav nav-tabs mt-3">
      <li class="nav-item">
        <a class="nav-link text-dark" href="<?php echo url_for('cashier/stock_adjustments/index.php')?>">Stock Adjustment</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active text-dark" href="#">Stock Adjustment History</a>
      </li>
<!--       <li class="nav-item">
        <a class="nav-link text-dark" href="<?php echo url_for('cashier/stock_adjustments/approve_adj.php')?>">Approve Adjustments</a>
      </li> -->
    </ul>
