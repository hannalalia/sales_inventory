...
<?php require('../../../private/shared/staff_navigation.php');?>
  <div class="container">
  <p class="my-3 col-sm-7 col-12 text-sm-left text-center"><a  class="text-secondary"href="<?php echo url_for('cashier/purchase_orders/index.php')?>">Purchase Orders</a> \ Create Purchase Orders</p>
