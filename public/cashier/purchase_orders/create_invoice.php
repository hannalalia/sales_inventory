...
<div class="container ">
	<div class="m-3 border border-secondary w-75"  id="printInvoice">
		<div class="d-flex justify-content-between align-items-center">		
			...
			<img class="img-fluid rounded mr-2" style="width: 5%; height: 5%" src="<?php echo url_for('cashier/resources/images/logo.jpg')?>"  alt="">
    ...
    <a class="btn btn-info text-light m-2" href="<?php echo url_for('cashier/purchase_orders/po_recon.php')?>" >Back</a>
