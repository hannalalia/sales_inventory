...
if(isset($_POST['received'])) {
  ...
  if($result === true) {
    ...
    redirect_to(url_for('cashier/purchase_orders/view.php?id='."$id"));
  } else {
    $errors = $result;
     $output = '';
...
<div class="container">
  <p class="my-3 col-sm-7 col-12 text-sm-left text-center"><a  class="text-secondary"href="<?php echo url_for('cashier/purchase_orders/index.php')?>">Purchase Orders</a> \ View Purchase Orders</p>
